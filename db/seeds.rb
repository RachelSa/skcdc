...
#
# gardiner = Classroom.create({name:"Gardiner Center", location:"12 Plummer Street
# Gardiner, ME 04345"})
#
# lr = Classroom.create({name:"Lake Region Center", location: "165 Lakeview Drive
# China, ME 04358"})
# my = Classroom.create({name:"Magic Years Center", location:"25 Industrial Drive
# Augusta, ME 04330"})
#
# my.programs << cc
# my.programs << hs
